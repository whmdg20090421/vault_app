...
- [x] Task 4: 编写 Dart 终极诊断脚本
  ...
  - 日志：如果诊断检测到异常，将详细的网络状态、接口信息、DNS 解析结果和 OS Error 信息格式化并持久化输出到本地报错日志文件中（或标准错误日志系统）。
- [x] Task 5: 总结与原因分析
