...
while true; do
  ...
  BRANCH=$(echo "$RUN_INFO" | grep -m 1 '"head_branch"' | cut -d '"' -f 4)
  HTML="<html><body><h1>CI Status: $STATUS</h1><h2>Conclusion: $CONCLUSION</h2><h3>Branch/Tag: $BRANCH</h3><p>$(date)</p></body></html>"
